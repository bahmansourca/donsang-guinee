  ...
  return (
    <html lang="fr" id="top">
      <body className="antialiased">
        ...
        <a href="#top" className="fixed bottom-5 right-5 z-50 inline-flex items-center justify-center w-11 h-11 rounded-full bg-[var(--brand-red)] text-white shadow-lg" aria-label="Retour en haut">↑</a>
        {children}
        <footer className="mt-16 border-t border-black/10">
          <div className="container py-8 grid gap-6 md:grid-cols-3 text-sm">
            ...
            <div>
              ...
              <p className="text-black/60">© {new Date().getFullYear()} Don de Sang Guinée</p>
            </div>
          </div>
        </footer>
      </body>
